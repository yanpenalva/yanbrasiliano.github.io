...
<template>
  <!-- Seção para o link do GitHub -->
  <section class="text-center mt-10">
    <a href="https://github.com/yanbrasiliano"
  ...
  <section class="pt-10 sm:pt-14">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-6 sm:gap-10">
      <ProjectSingle v-for="project in filteredProjects" :key="project.id" :project="project" :href="project.href" />
    </div>
  </section>
</template>
